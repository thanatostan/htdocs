...
?>
  <tr>
    ...
    <td align="center"><a href="admin_edit.php?User=<?php echo $objResult["USERNAME"];?>">Edit</a></td>
	<td align="center"><a href="admin_drop.php?User=<?php echo $objResult["USERNAME"];?>"onClick="return confirm('Are you sure?');"">Drop</a></td>
  </tr>
<?php
}
?>
...
<table width="600" class="table">
<td align="center"><a href="admin_add.php"><strong>Add</a></td>
