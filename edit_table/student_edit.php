...
<body>
<form action="student_save.php?User=<?php echo $_GET["User"];?>" name="frmEdit" method="post">
<?php
$objConnect = oci_connect("projectdb","projectdb","localhost/XE");
$strSQL = "SELECT * FROM student WHERE username = '".$_GET["User"]."' ";
...
<table  class="table">
  ...
  <tr>
	...
	<td align="center"><input type="text" class="form-control" name="school" size="20" value="<?php echo $objResult["SCHOOL"];?>"></td>
